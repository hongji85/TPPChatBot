...
const CustomerStore = require('../models/customerStore.js');
...
class OperatorConnectionHandler extends ChatConnectionHandler {
  ...
  _gotOperatorInput (message) {
    ...
    const customerId = message.customerObject.customerId;
    const customerName = message.customerObject.customerName;
    ...
    this.router.customerStore
      ...
      .then(customer => {
        ...
        History.insertHistory(customerId, customerName, utterance, 'operator');
